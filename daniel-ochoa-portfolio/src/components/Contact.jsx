...
const Contact = () => {
    return (
        <div name='contact' className="w-full h-screen bg-black flex  justify-center items-center p-4">
            <form method='POST' action='https://getform.io/f/paqgqgka' className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-pink-600 text-gray-300'>Contact</p>
                    <p className="text-gray-300 py-4">// Submit the form below or send an email - danochoa88@gmail.com</p>
                </div>
